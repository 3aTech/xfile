MONEDA_SINGULAR = 'Bolívar'
MONEDA_PLURAL = 'Bolívares'

CENTAVOS_SINGULAR = 'centimo'
CENTAVOS_PLURAL = 'centimos'

MONEDA_SINGULAR_ = 'Dolar'
MONEDA_PLURAL_ = 'Dolares'

CENTAVOS_SINGULAR_ = 'centavo'
CENTAVOS_PLURAL_ = 'centavos'
...
cadena1 = numero_a_moneda(37.10)
cadena6 = numero_a_letras(1001)
print(f"{cadena1=}")
