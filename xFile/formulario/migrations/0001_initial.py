# Generated by Django 5.1.5 on 2025-02-27 02:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipologia', models.CharField(help_text='Nombre de la Tipología', max_length=255, verbose_name='Nombre de la Tipología')),
                ('status', models.BooleanField(default=True, help_text='Estado de actividad', verbose_name='Estado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fe_us_mo', models.DateTimeField(auto_now=True, verbose_name='Fecha de Modificación')),
                ('id', models.AutoField(help_text='Código', primary_key=True, serialize=False, verbose_name='Código')),
                ('des_urb', models.CharField(help_text='Nombre del Urbanismo', max_length=255, verbose_name='Nombre del Urbanismo')),
                ('direccion', models.CharField(blank=True, help_text='Dirección del Urbanismo', max_length=255, null=True, verbose_name='Dirección')),
                ('status', models.BooleanField(default=True, help_text='Estado de actividad', verbose_name='Estado')),
                ('estado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='urbanismos', to='formulario.estados')),
                ('municipio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='urbanismos', to='formulario.municipios')),
                ('parroquia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='urbanismos', to='formulario.parroquias')),
                ('sector', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='urbanismos', to='formulario.sectores')),
                ('tipologia', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='urbanismos', to='formulario.tipologias_urb')),
            ],
            options={
